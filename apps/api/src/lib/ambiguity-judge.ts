...
3. OUT：问题属于其他明确非游戏领域（天气、股票、编程、烹饪等），且不涉及游戏产品语境
4. IN：**游戏产品设计/运营/营销类问题**（师徒系统、宣传视频/预告片方案、明星代言、皮肤风格、美术方向、抽卡/氪金机制、公会系统、匹配机制、赛季更新、新玩法立项等）——只要面向游戏或玩家语境，一律判定 IN（这类问题考察的是玩家视角的态度和偏好，属于"玩家偏好"范畴）
5. IN：问题明确与射击游戏有关（询问游戏机制、武器、战术、玩家偏好、游戏体验、版本更新等）
6. IN：问题包含射击游戏实体名称（CS2、Valorant、AK、AWP、Dust2 等）
7. IN：问题模糊但对话上下文明确为射击游戏语境
8. IN：问题无法确定是否与射击游戏相关，且上下文信息不足时，默认判定为 IN
