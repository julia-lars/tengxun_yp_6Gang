"""Analyze 美国HD端用户生态与决策链路研究 to find intro→game transition points."""
import docx, re, os
...
for fname in sorted(os.listdir(base)):
    ...
    for p in doc.paragraphs:
        ...
        if m:
            if cur_spk and cur_txt and cur_txt.strip(): turns.append((cur_spk, cur_txt.strip()))
